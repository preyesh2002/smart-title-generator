    ...
    try {
      ...
      const response = await fetch('/api/generate', {
        ...
        body: JSON.stringify({
          ...
          primaryAudiences: formData.primaryAudiences,
        }),
      });
      ...
      {showForm ? (
        <div className="container bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="marketplaces">Marketplaces:</label>
              <input className="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none focus:shadow-outline" type="text" name="marketplaces" value={formData.marketplaces} onChange={handleInputChange} />
            </div>
            <div className="mb-4">
              <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="toneOfVoice">Communication Style (Tone of Voice):</label>
              <input className="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none focus:shadow-outline" type="text" name="toneOfVoice" value={formData.toneOfVoice} onChange={handleInputChange} />
            </div>
            <div className="mb-4">
              <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="primaryAudiences">Primary Audiences:</label>
              <input className="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none focus:shadow-outline" type="text" name="primaryAudiences" value={formData.primaryAudiences} onChange={handleInputChange} />
            </div>
            <div className="mb-6">
        ...
        <div className="container bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 text-center">
          <h1 className="text-2xl font-bold mb-6">Generate a Product Description</h1>
          <button
            className="bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded m-2"
            onClick={() => {
              setShowForm(true);
              setUseProductName(false);
            }}
          >
            Use Product Image
          </button>
